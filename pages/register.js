        ...
        <div className="min-h-screen w-screen grid grid-cols-12">
            ...
            <div className="col-span-6 flex justify-around items-center flex-col gap-9">
                ...
                <div className="flex flex-col gap-16 text-center justify-between">
                    ...
                    <h2 className="text-gray-500 font-semibold">Get Registered and Enjoy</h2>
                </div>

                <div className="max-w-[70%] w-80 flex flex-col ">
                    <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
                        <label className="text-sm text-gray-400 font-semibold" htmlFor="name">Name</label>
                        <input
                        ...
                        />
                        <label className="text-sm text-gray-400 font-semibold mt-5" htmlFor="email">Email</label>
                        <input
                            className="border-b-2 py-1 text-lg text-gray-800 focus:border-[#A4C4B5] focus:outline-none placeholder:italic placeholder:text-slate-300 placeholder:text-base"
                            id="email"
                            type="email"
                        ...
                        />
                        <label className="text-sm text-gray-400 font-semibold mt-5" htmlFor="confirm password">Confirm Password</label>
                        <input
                            className="border-b-2 py-1 text-lg text-gray-800 focus:border-[#A4C4B5] focus:outline-none placeholder:italic placeholder:text-slate-300 placeholder:text-base"
                            id="confirm password"
                            type="password"
                            ...
                            {...register("Password", { required: true, maxLength: 100 })}
                        />
                        <p className="text-[.70rem] text-[#A4C4B5] self-end pt-2 cursor-pointer">Forgot password ?</p>
                        <input
